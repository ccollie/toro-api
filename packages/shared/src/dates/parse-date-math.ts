...
import { add, endOf, startOf, subtract } from './datetime';
...
export const unitsMap: UnitsMap = Object.freeze({
...
export function parseDateMath(
  ...
  return _parse(mathString, time, roundUp);
}

function _parse(mathString: string, time: Date, roundUp: boolean) {
  let dateTime = time;
