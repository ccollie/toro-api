...
export class Counter extends MonotoneCounter implements Counting, Metric {
  ...
  /**
   * Increases the current count by the given value - a negative value is
   * decreasing the current count.
   *
   * @param {number} value
   * @returns {this}
   * @memberof MonotoneCounter
  ...
  /**
   * Decreases the current count by the given value - a negative value is
