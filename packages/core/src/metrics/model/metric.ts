...
export function isSerializableMetric(
  ...
  if (
    ...
    (anyMetric.getMetadataMap &&
      typeof anyMetric.getMetadataMap === 'function') ||
...
export function getMetricDescription(
  metric: Metric | SerializableMetric,
): string {
  if (isSerializableMetric(metric)) {
...
export function getMetricMetadata(
  metric: MetadataContainer | SerializableMetric,
): Metadata {
  if (isSerializableMetric(metric)) {
