...
import {
  ...
  getJobSchemas,
  validateJobOptions,
  validateBySchema, validateJobData
} from '../../../src/server/queues';
import { getJobSchemaKey } from "../../../src/server/monitor/keys";
...
describe('jobSchema', function () {
  ...
  describe('compileSchema', () => {
    ...
    it('it should throw if no name is provided', () => {
      expect(() => compileSchema(null, simpleSchema)).toThrow(/job name is required/)
    });
