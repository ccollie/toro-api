...
describe('StreamingPeakDetector', () => {
  describe('constructor', () => {
    it('constructs an instance', () => {
      let sut = new StreamingPeakDetector(systemClock, 1000, 3.5, 0);
  ...
  describe('.isInLagPeriod', () => {
    it('calculates correctly', () => {
      ...
      let sut = new StreamingPeakDetector(clock, 1000, 3.5, 0);
      for (let i = 0; i < 10; i++) {
  ...
  describe('.update', () => {
    it('does not signal on a single value', () => {
      const clock = new ManualClock();
      let sut = new StreamingPeakDetector(clock, 0, 3.5, 0);
    ...
    it('calculates peaks', () => {
      ...
      let sut = new StreamingPeakDetector(clock, 30, 5, 0);
      let actual: number[] = [];
