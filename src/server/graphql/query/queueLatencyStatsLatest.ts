...
export const queueLatencyStatsLatest: FieldConfig = {
  type: JobStatsSnapshotTC.NonNull,
  description: 'Gets the last recorded latency stats snapshot',
  args: {
  ...
  async resolve(_, { input }) {
    ...
    return client.getLast(jobName, 'latency', _granularity);
  },
};
